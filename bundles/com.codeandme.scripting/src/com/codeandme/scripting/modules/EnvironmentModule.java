 ...
 */
public class EnvironmentModule implements IScriptEngineLaunchExtension, IScriptModule {
    ...
    private void loadModule(final IScriptModule module) {
        ...
        final IScriptModule loadedModule = findModule(module.getModuleName());
